    ...
    public class WeakenSpell : MagerySpell
    {
        ...
        public static void RemoveEffects(Mobile m, bool removeMod = true)
        {
            if (m_Table.ContainsKey(m))
            {
                ...
                m.Spell = null; // Clear the spell when its effect ends
                m_Table.Remove(m);
            }
        }
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckHSequence(m))
            {
                ...
                else
                {
                    ...
                    Console.WriteLine($"Weaken effect being applied to {m.Name}");
                    HarmfulSpell(m);

                    // Set the spell on the defender to make it visible in DoHarmful
                    m.Spell = this;
